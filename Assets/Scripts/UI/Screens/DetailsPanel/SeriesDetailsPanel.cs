    ...
    public class SeriesDetailsPanel : BaseDetailsPanel
    {
        ...
        public void HookUp(Series series)
        {
            if (series != null)
            {
                ...
                this.SetTextToDisplay(this.StartYear, series.StartYear.ToString());
                this.SetTextToDisplay(this.EndYear, series.EndYear.ToString());
                this.SetTextToDisplay(this.Rating, series.Rating);
